...
{
    public class clsCursoDiploma
    {
        private clsConec conec = null;
    

     public clsCursoDiploma(string host, string dataBase, string user, string pass)
       
        {
            conec = new clsConec(host, dataBase, user, pass);
        }
       public clsCursoDiploma()
        {
            conec = new clsConec();
        }
       ...
       public bool insert_cursosDiplo(string institucion_organizado, string nombre_curso, DateTime fecha_obtencion, int n_horas, string dni_persona)
       {
           try
           {
               cmd_insert_cursosDiplo(institucion_organizado, nombre_curso, fecha_obtencion, n_horas, dni_persona);
               return true;
           }
           catch (Exception)
           {
       ...
       public bool delete_cursosDiplo(int codi)
       {
           try
           {
               cmd_delete_cursosDiplo(codi);
               return true;
           }
