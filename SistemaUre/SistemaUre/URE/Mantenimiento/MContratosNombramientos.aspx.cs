...
{
    public partial class MContratosNombramientos : System.Web.UI.Page
    {
        ...
        private void listar_contratos(string DNI)
        {
            clsResoluciones cl = new clsResoluciones();
            GridContratos.DataSource = cl.listar_contratos(DNI);
        ...
        protected void btnIngresar_MDesmerito_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string nombreArchivo = imaCon.FileName;
                string foto = "../../Files/Resolucion/" + nombreArchivo;
                imaCon.SaveAs(Server.MapPath(foto));
                ...
                if (num_resolucion != "")
                {
                    ...
                    cl.insert_contratos(dni_persona, num_resolucion, Descripcion, fecha_registro, fecha_resol,foto,1);

                    txtDescrip.Text = "";
                    txtfecha_registro.Text = "";
                    txtfecha_resolucion.Text = "";
                    txtNumReso.Text = "";
                    listar_contratos(DNI);
        ...
        protected void btn_BuscarPo_Click1(object sender, EventArgs e)
        {
        ...
        protected void GridContratos_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            string DNI = txtdniPe.Text;
            GridViewRow r = GridContratos.Rows[e.RowIndex];
            Label codi = (r.FindControl("lblcodigo") as Label);
            clsResoluciones cl = new clsResoluciones();
            cl.delete_resoluciones(Convert.ToInt32(codi.Text));

            GridContratos.EditIndex = -1;
            this.listar_contratos(DNI);
        }

        protected void btnCancelar_MDesmerito_Click(object sender, EventArgs e)
        {
