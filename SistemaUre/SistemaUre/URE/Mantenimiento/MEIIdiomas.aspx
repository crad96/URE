<%@ Page Title="" Language="C#" MasterPageFile="~/URE/Mantenimiento/Mantenimiento.Master" AutoEventWireup="true" CodeBehind="MEIIdiomas.aspx.cs" Inherits="SistemaUre.URE.Mantenimiento.MEIIdiomas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
   ...
   <div style="vertical-align: 50%">
    ...
    <div class="panel panel-primary">
        ...
        <asp:GridView ID="GridIdiomas" runat="server" BackColor="White" BorderColor="#CCCCCC" AutoGenerateColumns="False" BorderStyle="None" BorderWidth="1px" CellPadding="3" OnRowDeleting="GridIdiomas_RowDeleting">
