<%@ Page Title="" Language="C#" MasterPageFile="~/URE/Mantenimiento/Mantenimiento.Master" AutoEventWireup="true" CodeBehind="ActualizarDocente.aspx.cs" Inherits="SistemaUre.URE.Mantenimiento.ActualizarDocente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
     ...
     <div>
        <div class="row" style="padding-bottom:8px;">
            <div class="col col-md-3" >
             ...
             <div class="col-md-1">                           
                <asp:Button ID="btn_BuscarPo" runat="server"  class="btn btn-primary" Text="Buscar" OnClick="btn_BuscarPo_Click"></asp:Button>                             
            </div>  
            ...
            <div class="col-md-2 col-md-offset-2">
                ...
                <asp:Button ID="Nuevo_registro" runat="server" class="btn btn-success" Text="Ingresar nuevo" PostBackUrl="~/URE/Mantenimiento/MDocente.aspx" > </asp:Button>                             
    ...
    <div class="col col-md-offset-4" style="padding:10px">
        <div class="btn-toolbar " role="toolbar">
            <asp:Button ID="btnactualizar_docente" runat="server" class=" btn btn-lg btn-primary"  Text="Agregar" OnClick="btnactualizar_docente_Click"></asp:Button>
