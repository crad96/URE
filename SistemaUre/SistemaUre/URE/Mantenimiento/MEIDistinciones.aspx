<%@ Page Title="" Language="C#" MasterPageFile="~/URE/Mantenimiento/Mantenimiento.Master" AutoEventWireup="true" CodeBehind="MEIDistinciones.aspx.cs" Inherits="SistemaUre.URE.Mantenimiento.MEIDistinciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
  <div style="vertical-align: 50%">
    ...
    <div class="panel panel-primary">
        ...
        <asp:GridView ID="GridDistincion_Reci" runat="server" AutoGenerateColumns="false" OnRowDeleting="GridDistincion_Reci_RowDeleting" >
            <Columns>
