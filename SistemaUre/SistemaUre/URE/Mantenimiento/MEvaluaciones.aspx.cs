...
{
    public partial class MEvaluaciones : System.Web.UI.Page
    {
        ...
        protected void btn_BuscarPo_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                listar_evaluaciones(DNI);
            }
        }

        private void listar_evaluaciones(string DNI)
        {
            clsResoluciones cl = new clsResoluciones();
            GridEvalua.DataSource = cl.listar_evaluaciones(DNI);
            GridEvalua.DataBind();
        }

        protected void btnIngresar_MEvalua_Click(object sender, EventArgs e)
        {
            try
            {
                string DNI = txtdniPe.Text;
                ...
                string nombreArchivo = imaEva.FileName;
                string foto = "../../Files/Resolucion/" + nombreArchivo;
                imaEva.SaveAs(Server.MapPath(foto));
                ...
                if (num_resolucion != "")
                {
                    ...
                    cl.insert_evaluaciones(dni_persona, num_resolucion, Descripcion, fecha_registro, fecha_resol,foto, 11);
        ...
        protected void GridEvalua_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            string DNI = txtdniPe.Text;
            GridViewRow r = GridEvalua.Rows[e.RowIndex];
            Label codi = (r.FindControl("lblcodigo") as Label);
            clsResoluciones cl = new clsResoluciones();
            cl.delete_resoluciones(Convert.ToInt32(codi.Text));

            GridEvalua.EditIndex = -1;
            this.listar_evaluaciones(DNI);
        }
