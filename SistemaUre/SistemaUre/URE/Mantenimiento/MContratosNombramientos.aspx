<%@ Page Title="" Language="C#" MasterPageFile="~/URE/Mantenimiento/Mantenimiento.Master" AutoEventWireup="true" CodeBehind="MContratosNombramientos.aspx.cs" Inherits="SistemaUre.URE.Mantenimiento.MContratosNombramientos" %>
 ...
 <div style="vertical-align: 50%">
        <div class="row">
            <div class="col-md-3 col-md-offset-3">
             ...
             <div class="col-md-1">                           
                <asp:Button ID="btn_BuscarPo" runat="server" class="btn btn-lg btn-primary" Text="Buscar" OnClick="btn_BuscarPo_Click1" ></asp:Button>                             
            </div>
            <br>
             <div class="col-md-3 col-md-offset-3">   
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <img src="../../Recursos/images/documento.png" style="margin: 10px" height="71"
                        width="100" />
                    <asp:FileUpload ID="imaCon" runat="server" />
   ...
   <div class="col-md-offset-4"> 
        <div class="btn-toolbar" role="toolbar">
           <asp:Button ID="btnIngresar_MDesmerito" runat="server"  long="10px"    CssClass="btn btn-lg btn-primary" Text="Agregar" OnClick="btnIngresar_MDesmerito_Click"></asp:Button>
           <asp:Button ID="btnCancelar_MDesmerito" runat="server" class="btn btn-lg btn-danger" Text="Cancelar" OnClick="btnCancelar_MDesmerito_Click"></asp:Button>
    ...
    <asp:GridView ID="GridContratos" runat="server" class="table table-striped tab-content" AutoGenerateColumns="False" Width="100%" CellPadding="1" ForeColor="#333333"  GridLines="None"
        OnRowDeleting="GridContratos_RowDeleting">


        <Columns>
                <asp:TemplateField HeaderText="Código"  Visible="true" HeaderStyle-Width="8%">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Nº Resolución" HeaderStyle-Width="20%">
                    <ItemTemplate>
                        <%#Eval("num_resolution")%>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Descripcion" HeaderStyle-Width="35%">
                    <ItemTemplate>
                        <%#Eval("Descripcion")%>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Direc_Fot" HeaderStyle-Width="15%">
                    <%--<ItemTemplate>
                        <%#Eval("foto")%>
                    </ItemTemplate>--%>

                    <ItemTemplate>
                        <asp:HyperLink ID="imaCon" runat="server" NavigateUrl='<%#Eval("foto","~/Files/Resolucion/{0}")%>' 
