<%@ Page Title="" Language="C#" MasterPageFile="~/URE/Mantenimiento/Mantenimiento.Master" AutoEventWireup="true" CodeBehind="MDemeritos.aspx.cs" Inherits="SistemaUre.URE.Mantenimiento.MDemeritos" %>

<asp:Content ID="Content2" ContentPlaceHolderID="Title" runat="server">
    <h1>
        DOCENTE
        <small>Desméritos</small>
      </h1>
      <ol class="breadcrumb">
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">DESMERITO</div>
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <img src="../../Recursos/images/documento.png" style="margin: 10px" height="71"
                        width="100" />
                    <asp:FileUpload ID="imaXD" runat="server" />
     ...
     <div class="col-md-offset-4"> 
        <div class="btn-toolbar" role="toolbar">        
            <asp:Button ID="btnIngresar_MDesmerito" runat="server" class="btn btn-lg btn-primary" Text="Agregar" OnClick="btnIngresar_MDesmerito_Click"></asp:Button>
            <asp:Button ID="btnCancelar_MDesmerito" runat="server" class="btn btn-lg btn-danger" Text="Cancelar"></asp:Button>
    ...
    <asp:GridView ID="GridDemeritos" runat="server" BackColor="White" BorderColor="#CCCCCC" AutoGenerateColumns="False" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="None" 
        OnRowDeleting="GridDemeritos_RowDeleting" OnRowUpdating="GridDemeritos_RowUpdating" OnRowEditing="GridDemeritos_RowEditing" OnRowCancelingEdit="GridDemeritos_RowCancelingEdit">
       <%-- <RowStyle BackColor="#EF3FB" />--%>
        ...
        <Columns>
                ...
                <asp:TemplateField HeaderText="Nº Resolucion" HeaderStyle-Width="25%">
                    <ItemTemplate>
                        <%#Eval("num_resolution")%>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Direc_Fot" HeaderStyle-Width="15%">
                    ...
                    <ItemTemplate>
                        <asp:HyperLink ID="imaXD" runat="server" NavigateUrl='<%#Eval("foto","~/Files/Resolucion/{0}")%>' 
                ...
                <asp:TemplateField HeaderText="Accion">
                    ...
                    <ItemTemplate>
                         <asp:Button ID="btnUpd" CommandName="Edit" class="btn btn-success" runat="server" Text="Edit "  />
