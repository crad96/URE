<%@ Page Title="" Language="C#" MasterPageFile="~/URE/Mantenimiento/Mantenimiento.Master" AutoEventWireup="true" CodeBehind="MEvaluaciones.aspx.cs" Inherits="SistemaUre.URE.Mantenimiento.MEvaluaciones" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <img src="../../Recursos/images/documento.png" style="margin: 10px" height="71"
                        width="100" />
                    <asp:FileUpload ID="imaEva" runat="server" />
   ...
   <div class="col-md-offset-4"> 
        <div class="btn-toolbar" role="toolbar">
           <asp:Button ID="btnIngresar_MEvalua" runat="server"  long="10px"    CssClass="btn btn-lg btn-primary" Text="Agregar" OnClick="btnIngresar_MEvalua_Click" ></asp:Button>
           <asp:Button ID="btnCancelar_MEvalua" runat="server" class="btn btn-lg btn-danger" Text="Cancelar"></asp:Button>
    ...
    <asp:GridView ID="GridEvalua" runat="server" class="table table-striped tab-content" AutoGenerateColumns="False" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDeleting="GridEvalua_RowDeleting">
        ...
        <Columns>
                ...
                <asp:TemplateField HeaderText="Direc_Fot" HeaderStyle-Width="10%">
                    ...
                    <ItemTemplate>
                        <asp:HyperLink ID="imaEva" runat="server" NavigateUrl='<%#Eval("foto","~/Files/Resolucion/{0}")%>' 
